...
#//Scan multiple targets specified with a comma else scan one specified
target//
#//Line 55 prevents the scan function from being called twice if the script
is imported into another module//
